...
def descifrar_cesar(texto, desplazamiento):
    ...
    # Mensaje viene en base64,lo decodificamos y lo transformamos a ASCII en Cesar #
    mensaje_decodificado = base64.b64decode(texto).decode('utf-8')

    resultado = ""
    for caracter in mensaje_decodificado:
        if caracter.isalpha():
...
def descifrado_window():
    ...
    # Proceso Principal #
    label = tk.Label(root, text="Mensaje a descifrar, ingresar en base64:")
    label.pack(pady=5)
